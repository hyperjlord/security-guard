        ...
        if (dx != 0) {
            ...
            if (Math.abs(k) <= 1) {
                ...
                for (x = from.longitude; x <= to.longitude; x = Operation.sum(x, 0.000001)) {
                    ...
                    Point point = new Point( (double) Math.round(y * 1000000) / 1000000, x, 0, 0);
                ...
                for (y = from.latitude; y <= to.latitude; y = Operation.sum(y, 0.000001)) {
                    Point point = new Point(y, (double) Math.round(x * 1000000) / 1000000, 0, 0);
                    temp_route.add(point);
